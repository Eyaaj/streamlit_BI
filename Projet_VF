...
# Ajouter une case à cocher pour afficher les données brutes
afficher_donnees_brutes = st.checkbox("Afficher les données brutes")

# Vérifier si la case à cocher est cochée
if afficher_donnees_brutes:
...
if approfondir_analyse == "Oui":
    ...
    fig = px.line(pdl_counts, x='annee', y='pdl', color='filiere', labels={'annee': 'Année', 'pdl': 'Nombre de points de livraison'},
